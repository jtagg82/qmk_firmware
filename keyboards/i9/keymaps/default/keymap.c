...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QW] = LAYOUT(	// default QWERTY layout with a few tweaks
	 JT_ESC,      KC_F1 , KC_F2 , KC_F3 , KC_F4 ,      KC_F5 , KC_F6 , KC_F7 , KC_F8 ,       KC_F9 , KC_F10, KC_F11, KC_F12,   KC_PSCR, TD_SCL,KC_PAUS,                           KC_MUTE,
	...
	[_FN] = LAYOUT(
	A(KC_F4),    _______,_______,_______,_______,     _______,_______,_______,_______,      _______,_______,_______,_______,   _______,KC_SCRL,QK_BOOT,                           _______,
